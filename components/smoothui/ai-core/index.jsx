 ...
 */
export const getAIStateAccentColor = (state, fallback) => {
 ...
 * ambient animation.
 */
export const useAudioAmplitude = (options = {}) => {
  const {
    autoStart = false,
 ...
 */
export const useSimulatedAmplitude = (state = "idle") => {
  const amplitude = useMotionValue(0);
